(function() {
  ...
  TableOfContentsNode = (function() {
    ...
    TableOfContentsNode.name = 'TableOfContentsNode';
    ...
    TableOfContentsNode.prototype.index = function() {
      ...
      if (!this._index) {
        ...
        while (q.length > 0) {
          ...
          if (item.handle) {
            this._index[item.handle] = item.id;
          }
        }
      }
      return this._index;
  ...
  TableOfContents = (function(_super) {
    ...
    TableOfContents.prototype.merge = function() {
      var child, subject, subjects, _i, _j, _len, _len1, _ref;
